      ...
      <header className="bg-white border-b px-6 py-4">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <nav className="flex gap-4">
            ...
            <Link href="/admin/content" className="text-blue-600 font-medium">{t("admin.content")}</Link>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-sm font-medium text-gray-500">{t("lessons.difficulty")}</th>
              ...
              <tbody>
                {lessons.map((lesson) => (
                  <tr key={lesson.$id} className="border-b last:border-0">
                    ...
                    <td className="px-6 py-4">{locale === "kk" ? lesson.title_kk : lesson.title_ru}</td>
                    <td className="px-6 py-4 text-sm">{lesson.category}</td>
